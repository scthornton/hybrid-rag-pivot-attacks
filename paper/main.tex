...
\item \textbf{Cross-dataset validation + organic leakage.} We
  demonstrate the vulnerability on three corpora: a synthetic enterprise
  corpus (1{,}000 documents, 4 tenants; RPR\,$=$\,0.95), the Enron email
  corpus (50{,}000 emails, 5 departments; RPR\,$=$\,0.70), and SEC EDGAR
  10-K filings (887 sections, 4 sectors; RPR\,$=$\,0.09)---all without
  adversarial injection. We present four
