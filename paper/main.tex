...
translates to generation-level contamination across both corpora, that
...
both corpora ($n{=}40$--181 leaking queries on Enron, $n{=}10$ on
...
($n{=}10$) is small; the Enron samples are more robust ($n{=}181$ for
GPT-5.2, $n{=}101$ for DeepSeek-V3, $n{=}40$ for Claude). We do not
